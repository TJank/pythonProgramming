...
class LaserCannon(Turtle):
    def __init__(self, xmin, xmax, ymin, ymax):
        ...
        self.screen.onclick(self.aimAndShoot)#we need to create a method for aim
        #self.screen.onkey(self.shoot, "s")   #we need to create a method for shoot
        self.screen.onkey(self.quit, "q")    #we need to create a method for quit

    def aimAndShoot(self, x, y,):
        # aim
